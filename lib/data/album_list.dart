...
class AlbumLists {
  static final List<(Album, String)> _classicAlbums = [
    ...
    (
      Album(
        albumId: '0wEbinOkDzYtORRfLnaCKL',
        name: '爵士純音樂',
        artistName: '播放清單',
      ),
      'playlist',
    ...
    (
      Album(
        albumId: '0cTOY5AW7XI8JV6FEAK9ty',
        name: '台語歌翻唱',
        artistName: '播放清單',
      ),
      'playlist',
  ...
  static final List<(Album, String)> _podcastRecommandation = [
    (
      Album(
  ...
  static final List<(Album, String)> _yourFavorites = [
    (
      Album(
  ...
  static final List<(Album, String)> _hitRadio = [
    (
      Album(
  ...
  static final List<(Album, String)> _noMatterWeather = [
    (
      Album(
  ...
  static final List<(Album, String)> _popMusic = [
    (
      Album(
  ...
  // 獲取特定列表的長度
  static int getListLength(int listIndex) {
    switch (listIndex) {
      case 0:
        return _classicAlbums.length;
      case 1:
        return _podcastRecommandation.length;
      case 2:
        return _yourFavorites.length;
      case 3:
        return _hitRadio.length;
      case 4:
        return _noMatterWeather.length;
      case 5:
        return _popMusic.length;
      default:
        return 0;
    }
  }
  ...
  // 根據列表索引和項目索引獲取專輯項目
  static (Album, String) getItem(int listIndex, int itemIndex) {
    switch (listIndex) {
      case 0:
        return _classicAlbums[itemIndex];
      case 1:
        return _podcastRecommandation[itemIndex];
      case 2:
        return _yourFavorites[itemIndex];
      case 3:
        return _hitRadio[itemIndex];
      case 4:
        return _noMatterWeather[itemIndex];
      case 5:
        return _popMusic[itemIndex];
      default:
        throw ArgumentError('Invalid list index');
    }
  }

  // 直接獲取整個專輯列表
  static List<(Album, String)> getItems(int listIndex) {
    switch (listIndex) {
      case 0:
        return _classicAlbums;
      case 1:
        return _podcastRecommandation;
      case 2:
        return _yourFavorites;
      case 3:
        return _hitRadio;
      case 4:
        return _noMatterWeather;
      case 5:
        return _popMusic;
      default:
        throw ArgumentError('Invalid list index');
